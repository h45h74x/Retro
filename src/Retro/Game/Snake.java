...
public class Snake extends Game {
    ...
    private final Entity[] body = new Entity[maxBody];
    ...
    private void generate() {
        ...
        for (int i = 1; i < lengthofsnake; i++) {
            if (body[i] == null)
                body[i] = new Entity(entity_size, entity_size + padding, Const.Snake.iconpaths[0]);
        }
    }

    private void generateFirst() {
        body[0] = new Entity(entity_size, entity_size + padding, Const.Snake.iconpaths[dir]);
    ...
    private void generateApple() {
        ...
        apple = new Entity(entity_size, entity_size + padding, Const.Snake.iconpaths[5]);
