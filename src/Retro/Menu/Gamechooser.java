...
public class Gamechooser extends Menu {
    ...
    protected void setup() {
        ...
        RoundButton bt1 = new RoundButton(Const.Strings.start);
        ...
        RoundButton bt2 = new RoundButton(Const.Strings.back);
    ...
    static class GameScrollPanel extends JPanel {
        private final Gamechooser parent;
        ...
        GameScrollPanel(Gamechooser parent) {
            super();
            this.parent = parent;
            height = getHeight();
            setup();
        ...
        private void loadImages() {
            ...
            for (int i = 0; i < numgames; i++) {
                try {
                    icons[i] = LookAndFeel.getImage(Const.Games.icons[i]);
